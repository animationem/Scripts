...
class punchHolesUI(object):
    ...
    def docs_help(self, *args):
        doc_help = mc.confirmDialog(
            ...
            '\n\t3. Select and store the triangular faces and border edge into variables'
            '\n\t4. Extrude the faces'
            '\n\t5. Store internal edges from the extrusion'
            '\n\t6. Select the border edges from before & after extrusion'
            '\n\t7. Bevel the edges'
            '\n\t8. Quadrangulate the extruded faces'
            '\n\n\nEdges\n'
            'Configure your settings and the script will run over the following steps:\n'
            ...
            '\n\t4. Store the border edges in a variable'
            '\n\t5. Select all faces with triangles and blast them away'
            '\n\t6. Select all Quad faces and extrude the geometry'
            '\n\t7. Store the border edges in another variable'
            '\n\t8. Select all border edges'
